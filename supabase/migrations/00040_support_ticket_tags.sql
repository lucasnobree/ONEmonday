...
-- Access is gated on sector membership via user_has_sector_access().
-- =============================================
...
CREATE POLICY "ticket_tags_insert" ON ticket_tags
  ...
  WITH CHECK (user_has_sector_access(sector_id));
...
-- A user may link/unlink a tag only when they can access the ticket's sector.
-- =============================================
